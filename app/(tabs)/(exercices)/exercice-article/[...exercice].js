...
export default function Article() {
    ...
    const { exercice } = useLocalSearchParams()
    const _id = exercice[0]
    ...
    // useFocusEffect pour vérifier si l'article est en favoris, naviguer vers exercice si l'article test a été supprimé ou si un nouveau a été mis en test
    ...
    return (
        <View style={styles.body}>
            ...
            <LinearGradient
                ...
                style={styles.header}
            >
                <TouchableOpacity style={styles.headerSection} onPress={() => router.navigate('/exercices')}>
            ...
            <ScrollView style={styles.body} contentContainerStyle={styles.contentBody}>
                <Text style={styles.categoryTitle}>Exercice</Text>
